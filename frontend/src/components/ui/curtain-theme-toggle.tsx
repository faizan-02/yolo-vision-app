...
// ─── Design tokens (Customized to match YOLO Vision theme) ──────────────────────

const TOKENS: Record<Theme, Record<string, string>> = {
  light: {
    pageBg:    "#f8fafc", // bg-slate-50
    pageText:  "#0f172a",
    barBg:     "rgba(255, 255, 255, 0.7)",
    barText:   "#0f172a",
    barBorder: "rgba(226, 232, 240, 0.6)",
    btnBg:     "#ffffff",
    btnText:   "#475569", // slate-600
    btnRing:   "rgba(226, 232, 240, 0.8)",
    inputBg:   "rgba(0,0,0,0.05)",
    inputText: "#0f172a",
  },
  dark: {
    pageBg:    "#0b0f19", // bg-[#0b0f19]
    pageText:  "#f8fafc",
    barBg:     "rgba(19, 27, 46, 0.75)",
    barText:   "#f8fafc",
    barBorder: "rgba(30, 41, 59, 0.6)",
    btnBg:     "#1e293b", // slate-800
    btnText:   "#fbbf24", // amber-400
    btnRing:   "rgba(51, 65, 85, 0.8)",
...
export function ThemeToggle({
  ...
  useEffect(() => {
    if (typeof document !== "undefined") {
      ...
      const actualTheme = saved === "dark" || saved === "light" ? saved : (isDark ? "dark" : "light");
  ...
  const btnScale = pressed ? 0.94 : hovered ? 1.08 : 1;
