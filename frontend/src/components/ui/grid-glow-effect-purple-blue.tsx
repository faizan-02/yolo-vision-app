...
const gradients = {
  ...
  "blue-purple": `repeating-conic-gradient(
                    from calc(var(--start) * 1deg) at 50% 50%,
                    rgba(59, 130, 246, 1) 0%,
                    rgba(147, 51, 234, 1) calc(25% / var(--repeating-conic-gradient-times)),
                    rgba(236, 72, 153, 1) calc(50% / var(--repeating-conic-gradient-times)),
                    rgba(99, 102, 241, 1) calc(75% / var(--repeating-conic-gradient-times)),
                    rgba(59, 130, 246, 1) calc(100% / var(--repeating-conic-gradient-times))
                  )`,
};
        ...
        >
          <div
            className={cn(
              ...
              "after:[mask-image:linear-gradient(#0000,#0000),conic-gradient(from_calc((var(--start)-var(--spread))*1deg),#00000000_0deg,#fff_calc(var(--spread)*0.94deg),#fff_calc(var(--spread)*1.06deg),#00000000_calc(var(--spread)*2deg))]"
            )}
          />
        </div>
      </>
